...
Widget editTask(BuildContext context, currentItem) => IconButton(         //редактирование задания
    icon: Icon(
      Icons.edit,
    ...
    onPressed: () {
      showDialog(
          ...
          builder: (BuildContext context) {
            return _editForm(currentItem, context);
          });
    });

Widget _editForm(currentItem, BuildContext context) => AlertDialog(     //окно редактирования
      scrollable: true,
